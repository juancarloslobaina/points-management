...
import es.qabit.pm.service.TransactionQueryService;
import es.qabit.pm.service.TransactionService;
import es.qabit.pm.service.criteria.TransactionCriteria;
...
/**
 * REST controller for managing {@link es.qabit.pm.domain.Transaction}.
 */
@RestController
@RequestMapping("/api")
public class TransactionResource {
    ...
    public ResponseEntity<TransactionDTO> createTransaction(@Valid @RequestBody TransactionDTO transactionDTO) throws URISyntaxException {
        ...
        try {
            ...
            throw new BadRequestAlertException(e.getMessage(), ENTITY_NAME, "insufficientbalance");
        }
    }
