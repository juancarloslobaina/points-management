...
import es.qabit.pm.service.MailService;
import es.qabit.pm.service.UserService;
import es.qabit.pm.service.dto.AdminUserDTO;
import es.qabit.pm.web.rest.errors.BadRequestAlertException;
import es.qabit.pm.web.rest.errors.EmailAlreadyUsedException;
import es.qabit.pm.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link es.qabit.pm.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
